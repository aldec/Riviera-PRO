...
# Created on: Mon May 15 07:35:59 CEST 2023
#
...
transcript on
asim +access +r +m+vitis_design_wrapper_sim_wrapper -L unisims_ver -L unimacro_ver -L secureip -L xpm -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_17 -L xlconcat_v2_1_4 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axis_infrastructure_v1_1_0 -L axis_register_slice_v1_1_26 -L axis_dwidth_converter_v1_1_25 -L xilinx_vip -O5 +access +r xil_defaultlib.vitis_design_wrapper_sim_wrapper xil_defaultlib.glbl

###################### asim for Code Coverage ####################################
#asim +access +r +m+vitis_design_wrapper_sim_wrapper -L unisims_ver -L unimacro_ver -L secureip -L xpm -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_17 -L xlconcat_v2_1_4 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axis_infrastructure_v1_1_0 -L axis_register_slice_v1_1_26 -L axis_dwidth_converter_v1_1_25 -L xilinx_vip -O5 +access +r -acdb -acdb_file code_coverage.acdb -cc_all xil_defaultlib.vitis_design_wrapper_sim_wrapper xil_defaultlib.glbl
...
if { ![batch_mode] } {
	...
	wave -vgroup "S2MM" -rec sim:/vitis_design_wrapper_sim_wrapper/vitis_design_wrapper_i/vitis_design_i/s2mm/*
...
if { [batch_mode] } {
  ...
  #acdb report -noinfo -db code_coverage.acdb -replace_path <Example_path>/06-versal-system-design-clocking-tutorial/ <Example_path>/06-versal-system-design-clocking-tutorial/_x/link/vivado/vpl/prj/ -html -o code_coverage_report.html     
  quit -force
}
